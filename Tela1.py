...
class Application:
    def __init__(self, master=None):
        ...
        self.titulo = Label(self.container1, text="Dados :")
        ...
        self.btnBuscar.configure(background='Cyan')
        ...
        self.bntInsert.configure(background='Cyan')
